...
export default function Story(){
    return(
        <>
            <h3 className="pageTitle">Business needs</h3>
        <div className="story">
            ...
            <div className="story__text">
                    <h2 className="story__text__title">Connections for your business!</h2>
                    <p className="story__text__paragraph">
                        Connection is the most important thing needed in our daily lives. Connection is the source of all our joys. A business without connection will struggle with communication and never clearly communicate to their clients.
                    </p>
                    <br/>
                    <br/>
